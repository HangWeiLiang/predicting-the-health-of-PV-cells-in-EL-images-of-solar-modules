...
def train_and_evaluate_model(X_train, y_train, X_test, y_test, input_shape, num_classes, dropout_rate=0.5,
    ...
    model = create_innovative_cnn_with_dropout(input_shape=input_shape, num_classes=num_classes,
...
model_total, history_total, test_acc_tatal = train_and_evaluate_model(X_train, y_train, X_test, y_test,
                                                                      input_shape=(64, 64, 1), num_classes=10,
                                                                      dropout_rate=0.5, batch_size=32, epochs=1)
model_poly, history_poly, test_acc_poly = train_and_evaluate_model(poly_X_train, poly_y_train, poly_X_test, poly_y_test,
                                                                   input_shape=(64, 64, 1), num_classes=10,
                                                                   dropout_rate=0.5, batch_size=32, epochs=1)
model_mono, history_mono, test_acc_mono = train_and_evaluate_model(mono_X_train, mono_y_train, mono_X_test, mono_y_test,
                                                                   input_shape=(64, 64, 1), num_classes=10,
                                                                   dropout_rate=0.5, batch_size=32, epochs=1)
