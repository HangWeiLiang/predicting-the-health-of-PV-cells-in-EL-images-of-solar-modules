...
from data_pre import X_train, X_test, y_train, y_test, types_train, types_test
from data_pre import mono_X_train, mono_X_test, poly_X_train, poly_X_test, mono_y_train, mono_y_test, poly_y_train, poly_y_test
